                                        ...
                                        <div class="card-body"> 
                                            <table class="table table-auto  w-full border  bg-primary text-white ">
                                                ...
                                                <thead class="sticky top-0 z-10">
                                                    <tr class="h-20">  
                                                        <th scope="col" class="px-6 px-6 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">N°</th>
                                                        ...
                                                        <th scope="col" class="px-6 py-3 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">Catégorie</th>
                                                        <th scope="col" class="px-6 py-3 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">Date Arrivée</th>
                                                        <th scope="col" class="px-6 py-3 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">N° Courrier</th>
                                                        ...
                                                        <th scope="col" class="px-6 py-3 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">Désignation</th>
                                                        ...
                                                        <th scope="col" class="px-6 py-3 bg-primary text-white text-sm text-center border-l border-primary-only font-bold whitespace-nowrap">Nombre Pièces</th>
                                                ...
                                                <tbody sortedinstance>
                                                    <tr v-for="(arrivee, index) in filteredInstance" :key="arrivee.id"  class="bg-white text-primary-txt leading-8">
                                                        ...
                                                        <td scope="col" class="px-6 py-3 text-center font-bold text-sm border border-primary-only whitespace-nowrap" :class="arrivee.isOverdue ? 'text-red-600 font-bold' : ''">{{ arrivee.txt_numdordre }}</td> 
