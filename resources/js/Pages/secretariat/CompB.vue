  ...
  <div class="sm:col-span-12" >
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4"> 
          <div class="sm:col-span-1">
              ...
              <div class="mt-2">  
                  <select name="ussu_bornage" id="Bornage" class="col-start-1 row-start-1 w-full 
          ...
          <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                  <select type="text" name="slt_lf" id="LF" autocomplete="address-level2" class="block w-full rounded-md bg-white 
                  px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 
                  outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 
                  focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
          ...
          <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                  <input type="text" name="txt_num_requisition" id="Num_requisition" autocomplete="address-level2" class="block w-full rounded-md bg-white 
                  px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 
                  outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 
                  focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
          ...
          <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                  <input type="text" name="txt_surface_bornage" id="Surface_bornage" autocomplete="address-level2" class="block w-full rounded-md bg-white 
                  px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 
                  outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 
                  focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
          ...
          <div class="sm:col-span-1">
              ...
              <div class="mt-2">
                  <input type="text" name="dt_date_bornage" id="Date_bornage" autocomplete="address-level2" class="block w-full rounded-md bg-white 
                  px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 
                  outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 
                  focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
          ...
          <div class="sm:col-span-2">
              ...
              <div class="mt-2">
                  <input type="text" name="txt_nom_geometre" id="Nom_geometre" autocomplete="address-level2" class="block w-full rounded-md bg-white 
                  px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 
                  outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 
                  focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
              </div>
