                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    :href="route('secretariat.create')"
                                    :active="route().current('secretariat.create')"
                                >
                                ...
                                <NavLink
                                    :href="route('geometre.create')"
                                    :active="route().current('geometre.create')"
                                >
                                ...
                                <NavLink
                                    :href="route('matriceCadastrale.create')"
                                    :active="route().current('matriceCadastrale.create')"
                                >
                                        Matrice Cadastrale
                                </NavLink>

                                <NavLink
                                    :href="route('donnee.create')"
                                    :active="route().current('donnee.create')"
                                >
                                        Base de Données
                                </NavLink>
